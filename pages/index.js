    ...
    <div className={styles.container}>
      ...
      <div className="presenters">
        ...
        <div className="host-container">
          <Person
            ...
            socials={{
              ...
              youtube:
                "https://www.youtube.com/channel/UCA3-nIYWu4PTWkb6NwhEpzg",
              twitter:
          ...
          <Person
            ...
            socials={{
              ...
              twitter:
                "https://twitter.com/nohandsnoexcuse?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor",
            }}
          ...
          <Person
            ...
            socials={{
              ...
              twitter:
                "https://twitter.com/negaoryx?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor",
            }}
            image={"/negaory.png"}
          />
          <Person
          ...
          <Person
            ...
            socials={{
              ...
              twitter:
                "https://twitter.com/DeafGamersTV?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor",
            }}
        ...
        <div className="faq container">
          ...
          <p>
            The Video Game Accessibility Awards is an awards show created with
            the hopes of encouraging more development studios to develop their
            games with accessibility, and disabled gamers, in mind. We also
            intend to shine a positive, celebratory light on the studios who are
            making positive strides in this space, and to encourage different
            kinds of gamers to tune in to learn more about the importance of
            accessibility. The VGAAs are all about being fun, informative, and
            positive.
          </p>
          ...
          <p>
            The 2021 Video Game Accessibility Awards are hosted by Alanah
            Pearce, a video game writer and content creator, and Steven Spohn,
            senior director at Able Gamers, and… also content creator.
          </p>
          <h3>How did you choose these categories?</h3>
          <p>
            The Video Game Accessibility Awards are powered by AbleGamers
            Accessible Player Experiences program, which trains the industry’s
            top developing studios to design with accessibility in mind. There
            are 22 design patterns that focus on the various challenges gamers
            with disabilities must face in order to play video games. While we
            would love to do the work for every pattern, we choose 10-12 to
            represent as large of a swath of the disability community as
            possible, while still being a concise, enjoyable show for the
            audience to watch.
          </p>
          <h3>How does the voting jury work?</h3>
          <p>
            Awards winners are entirely selected by the AbleGamers’ Player
            Panels, which is a group of hundreds of gamers with disabilities who
            love helping the video game industry be more accessible. After they
            have submitted their votes, the results are tabulated and given to
            our producers.
          </p>
          <h3>Can I vote?</h3>
          <p>
            Voting has closed for this year but you can always join AbleGamers
            Player Panels to join in next year’s voting process.
          </p>
          <h3>How do you choose your presenters?</h3>
          <p>
            Every year we do our best to have a solid mix of able-bodied and
            disabled celebrities, influencers, and talent you know and love.
          </p>
          <h3>
            How can I reach out to co-stream the event, donate, or otherwise
            support the Video Game Accessibility Awards?
          </h3>
          <p>
            You can send an email to{" "}
            <a href="mailto:vgaawards@gmail.com">vgaawards@gmail.com</a>
          </p>
        </div>
